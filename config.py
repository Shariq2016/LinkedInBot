...
email = "ShahShariqsde@gmail.com"
password = "rathPora@1997"
...
location = ["Remote","Europe", "Asia", "Australia", "NorthAmerica", "SouthAmerica", "Africa", "Australia"]
# keywords related with your job search
keywords = ['backend', 'java', 'spring boot', 'python', 'react', 'azure', 'aws', 'sql', 'software engineer','c#']
...
onlyApplyTitles = ['Backend Engineer', 'Software Engineer', 'Full Stack Developer']
...
LinkedInProfileURL = "https://www.linkedin.com/in/shahshariq"
Phone = "+91-7006694956" #OPTIONAL
Location = "Bengaluru, Karnataka" #OPTIONAL
